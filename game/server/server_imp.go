...
func (svr *Server) GetProtocolVersion() string {
	return w2d_version.ProtocolVersion
}
...
func (svr *Server) GetProtocolStat() *w2d_statserveapi.StatServeAPI {
	return svr.apiStat
}
func (svr *Server) GetNotiStat() *w2d_statnoti.StatNotification {
	return svr.notiStat
}
func (svr *Server) GetErrorStat() *w2d_statapierror.StatAPIError {
