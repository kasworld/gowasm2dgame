...
var allAuthorizationSet = map[string]*AuthorizedCmds{
	"PreLogin": NewByCmdIDList([]w2d_idcmd.CommandID{
		w2d_idcmd.Login,
	}),

	"DelAfterLogin": NewByCmdIDList([]w2d_idcmd.CommandID{
		w2d_idcmd.Login,
	}),

	"Login": NewByCmdIDList([]w2d_idcmd.CommandID{
		w2d_idcmd.Heartbeat,
		w2d_idcmd.Chat,
	}),
	"Admin": NewByCmdIDList([]w2d_idcmd.CommandID{}),
}
